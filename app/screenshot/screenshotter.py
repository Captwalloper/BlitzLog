...
from app.util import startInDefaultProgram
from app.config.config import Config

class Screenshotter:
    def __init__(self, config: Config):
        self.config = config
        self.newestScreenshot = None
    ...
    # needs self because of how this will invoked via callback... Python is weird man...
    def awaitNewScreenshot(self):
        sleep(2)
